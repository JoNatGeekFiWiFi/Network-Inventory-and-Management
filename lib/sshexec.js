 ...
 */
export async function sshExec({ host, username, password, port = 22, timeoutMs = 12000, argv, privateKey = null }) {
  ...
  return new Promise((resolve) => {
    ...
    conn.on('error', (e) => {
      ...
      finish({
        ok: false,
        error: auth ? 'SSH rejected the username or password' : e.message,
        authFailed: auth,
